            ...
            <div className="footer-2-1 container-xxl mx-auto position-relative p-0" style={{ fontFamily: 'Poppins, sans-serif' }}>
                <div className="list-footer">
                    <div className="row gap-md-0 gap-3">
                            ...
                            <div className="">
                                <div className="list-space">
                                    <p className="footer-memorable">
                                        Make it memorable! Follow us and check out our latest event.
                                    </p>
                                    <div
                                        className="d-flex title-font font-medium align-items-center gap-4"
                                    >
                                        <a href="">
                                            <svg
                        ...
                        <div className="col-lg-6 col-md-6">
                            <h1 className="footer-memorable">
                                Get in touch with us!<br />Leave your contact information below.
                            </h1>
                            <p className="menu-caption">
                                Fill up the form now, we promise not to spam you and will
                                provide important information to improve your account.
                            </p>
